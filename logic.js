      ...
      function redrawList(){
        ...
        $.each(api,function(index,value){
          ...
          if (formatter4.format(value.price_change_percentage_24h) > 0 || formatter4.format(value.price_change_percentage_24h) == 0) {
            ...
            //output as green
            $("<td/>").html( "<span class='green'>" + "+" + formatter4.format(value.price_change_percentage_24h) + "% </span>").appendTo(table);

          } else {

            //output as red
            $("<td/>").html( "<span class='red'>" + formatter4.format(value.price_change_percentage_24h) + "%</span>").appendTo(table);
          };
          ...
          if (formatter5.format(value.price_change_24h) > 0) {
            ...
            //output as green
            $("<td/>").html( "<span class='green1'>" + "+" + formatter5.format(value.price_change_24h) + "</span>").appendTo(table);

          } else {

            //output as red
            $("<td/>").html( "<span class='red1'>"+formatter5.format(value.price_change_24h) + "</span>").appendTo(table);
